...
| :--- | :--- |
| **Tác giả** | Tong Zhang (HKUST / University of Illinois Urbana-Champaign) |
| **Nhà xuất bản** | Cambridge University Press (2023) |
| **ISBN** | 978-1-009-36367-9 (Hardback) \| 978-1-009-36369-3 (Paperback) |
| **Liên kết chính thức** | [Website sách chính thức (tongzhang-ml.org)](https://tongzhang-ml.org/lt-book/) |
| **Bản PDF miễn phí** | [Tải PDF chính thức (tongzhang-ml.org)](https://tongzhang-ml.org/lt-book/lt-book.pdf) |
| **Quyền truy cập** | Bản in do Cambridge University Press phát hành. Tác giả cung cấp bản PDF đầy đủ công khai trên trang web chính thức phục vụ học thuật. |

---

## 2. Tóm tắt cốt lõi (Executive Summary)

*Mathematical Analysis of Machine Learning Algorithms* là công trình nghiên cứu hiện đại và chuyên sâu hàng đầu về phân tích toán học cho ML. Cuốn sách kết hợp chặt chẽ ba trụ cột: các bất đẳng thức nồng độ xác suất (concentration inequalities), phân tích thuật toán tối ưu hóa lồi/phi lồi (SGD, Variance Reduction), và lý thuyết ra quyết định tuần tự (Multi-Armed Bandits, Reinforcement Learning Theory).
