...
| :--- | :--- |
| **Tác giả** | Bernhard Mehlig (Department of Physics, University of Gothenburg) |
| **Nhà xuất bản** | Cambridge University Press (2021) |
| **ISBN** | 978-1-108-84480-2 (Hardback) \| 978-1-108-95337-5 (Paperback) |
| **Liên kết chính thức** | [Trang arXiv chính thức](https://arxiv.org/abs/1901.05639) |
| **Bản PDF miễn phí** | [Tải PDF chính thức (arXiv:1901.05639)](https://arxiv.org/pdf/1901.05639) |
| **Quyền truy cập** | Bản thảo hoàn chỉnh của sách được tác giả phát hành mở trên kho lưu trữ khoa học arXiv. |

---

## 2. Tóm tắt cốt lõi (Executive Summary)

*Machine Learning with Neural Networks* tiếp cận học sâu và mạng neural nhân tạo từ nền tảng vật lý thống kê (Statistical Physics) và cơ học thống kê. Tác phẩm phân tích cơ chế học của perceptron, mạng Hopfield, mô hình dựa trên năng lượng (energy-based models) và mạng nhiều lớp sâu dưới góc nhìn động lực học hệ thống phức tạp.
